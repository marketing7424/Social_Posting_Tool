...
function rowToMerchant(row) {
  return {
    ...
    fbLastCheckOk: row.fb_last_check_ok === 1,
    fbLastCheckError: row.fb_last_check_error || '',
    igLastCheckAt: row.ig_last_check_at || '',
    igLastCheckOk: row.ig_last_check_ok === 1,
    igLastCheckError: row.ig_last_check_error || '',
    googleLastCheckAt: row.google_last_check_at || '',
    googleLastCheckOk: row.google_last_check_ok === 1,
    googleLastCheckError: row.google_last_check_error || '',
